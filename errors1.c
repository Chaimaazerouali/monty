...
/**
 * handle_error - Prints appropriate error
 *					messages determined by their error code.
...
/**
 * error_switch - show appropriate error message based on error_code
 * @error_code: int representing which error to trigger
 * @args: line number and parametre if given
 *
 * Return: void
 */
